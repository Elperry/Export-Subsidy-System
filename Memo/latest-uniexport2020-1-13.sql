...
(40,3,'192800009',54,539178.18,'2019-10-07 00:00:00'),
(41,3,'192320005',71,22100,'2019-08-20 00:00:00'),
(42,3,'192880010',71,139598.7,'2019-10-15 00:00:00'),
(43,3,'192970006',54,17392.2,'2019-10-24 00:00:00'),
(44,3,'192930014',54,26711.21,'2019-10-20 00:00:00'),
(45,3,'192870004',54,192061.33,'2019-10-14 00:00:00'),
(46,3,'193070011',54,58582.44,'2019-11-03 00:00:00'),
(47,3,'192970111',49,14439,'2019-10-24 00:00:00'),
(48,3,'192930044',49,15284.6,'2019-10-20 00:00:00'),
(49,3,'193210006',54,202387.66,'2019-11-17 00:00:00'),
(50,3,'193240006',71,69960,'2019-11-20 00:00:00'),
(51,3,'193110007',71,69609.52,'2019-12-07 00:00:00'),
(52,3,'193210036',49,34006.38,'2019-11-17 00:00:00'),
(53,3,'192270064',49,35607.28,'2019-09-19 00:00:00'),
(54,3,'190620018',49,38003.4,'2019-03-03 00:00:00'),
(55,3,'191320029',49,45271.95,'2019-05-12 00:00:00'),
(56,3,'193370052',49,31893,'2019-12-03 00:00:00'),
(57,3,'193350006',71,294953.08,'2019-12-01 00:00:00'),
(58,3,'193350008',37,47908.55,'2019-12-01 00:00:00');
...
(6,'Dov',6,6,0.12),
(7,'Clear Shampoo',9,6,0.12),
(8,'signal',8,6,0.11),
(9,'Comfort',7,6,0.12),
(10,'fair& loely cream',5,6,0.1),
(11,'Sunsilk Shampoo',9,6,0.1),
(12,'Lux Shower Gel',6,6,0.1),
(13,'Close Up',8,6,0.11),
(14,'camy',6,6,0.1),
(15,'forest',8,6,0.09),
(16,'Ù…ÙˆØ§Ø¯ ØªØ­Ø¶ÙŠØ± ØµÙ†Ø§Ø¹ÙŠ',8,6,0.12),
...
(241,3,'TRANSWORLD LOGISTICS FZE',' ',' ',' ',54,' ',' '),
(242,3,'INJAZ SUPPLY AND DISTRIBUTION COMPANY',' ',' ',' ',45,' ',' '),
(243,3,'ENDURANCE',' ',' ',' ',63,' ',' '),
(244,3,'Bid Foodservice Middle East',' ',' ',' ',45,' ',' '),
(245,3,'Bid Foodservice Middle East','','','',45,'',''),
(246,3,'ECCHARD STREET FATTAL BUILDING','','','',63,'',''),
(247,3,'ENDURANCE','','','',63,'',''),
(248,3,'INTERNATIONAL EXPERTS GROUP FOR TRADE',' ',' ',' ',45,' ',' ');
...
(2026,'34560',3,'2019-08-28 00:00:00',41,10,4,1,0,0,16.5,0,NULL,'FOB'),
(2027,'34771',3,'2019-08-29 00:00:00',53,10,4,1,0,0,16.5,1,NULL,''),
(2028,'33356',3,'2019-08-18 00:00:00',47,10,4,1,0,0,16.5,0,NULL,''),
(2029,'10883',3,'2019-05-28 00:00:00',70,11,4,1,5136,0,17.5,0,NULL,''),
(2030,'36749',3,'2019-09-18 00:00:00',54,10,4,1,0,0,16.5,0,NULL,' '),
(2031,'37135',3,'2019-09-21 00:00:00',47,10,4,1,0,0,16.5,0,NULL,' '),
(2032,'35847',3,'2019-09-10 00:00:00',53,10,4,1,0,0,16.5,0,NULL,''),
(2033,'18386',3,'2019-09-19 00:00:00',45,11,4,1,0,0,16.5,0,NULL,' '),
(2034,'18664',3,'2019-09-24 00:00:00',37,11,4,1,403,0,16.5,0,NULL,' '),
(2035,'18210',3,'2019-09-17 00:00:00',63,11,4,1,0,0,16.5,0,NULL,' '),
(2036,'18682',3,'2019-09-24 00:00:00',49,11,4,1,516,0,16.5,0,NULL,' '),
(2037,'18245',3,'2019-09-18 00:00:00',49,11,4,1,516,0,16.5,0,NULL,' '),
(2038,'36239',3,'2019-09-14 00:00:00',70,10,4,1,4562,0,16.5,0,NULL,' '),
(2039,'37342',3,'2019-09-23 00:00:00',54,10,4,1,0,0,16.5,0,NULL,' '),
(2040,'37896',3,'2019-09-26 00:00:00',53,10,4,1,0,0,16.5,0,NULL,' '),
(2041,'37895',3,'2019-09-26 00:00:00',47,10,4,1,0,0,16.5,0,NULL,' '),
(2042,'37216',3,'2019-09-22 00:00:00',54,10,4,1,0,0,16.5,0,NULL,' '),
(2043,'18977',3,'2019-09-28 00:00:00',63,11,4,1,0,0,16.5,0,NULL,' '),
(2044,'37988',3,'2019-09-28 00:00:00',53,10,4,1,0,0,16.5,0,NULL,' '),
(2045,'37889',3,'2019-09-26 00:00:00',54,10,4,1,0,0,16.5,0,NULL,' '),
(2046,'36124',3,'2019-09-12 00:00:00',47,10,4,1,656,0,16.5,0,NULL,' '),
(2047,'38105',3,'2019-09-29 00:00:00',37,10,4,1,398,0,16.5,0,NULL,' '),
(2048,'31461',3,'2019-07-24 00:00:00',37,10,4,1,561,0,16.5,0,NULL,' '),
(2049,'18973',3,'2019-09-28 00:00:00',45,11,4,1,0,0,16.5,0,NULL,' محتاجين فواتير من الغذائية'),
(2050,'18902',3,'2019-09-26 00:00:00',45,11,4,1,0,0,16.5,0,NULL,' '),
(2051,'18536',3,'2019-09-22 00:00:00',63,11,4,1,0,0,16.5,0,NULL,' ');
...
(331,'183293',3,'2019-10-21 00:00:00',1),
(332,'183294',3,'2019-10-21 00:00:00',1),
(333,'183295',3,'2019-10-21 00:00:00',1),
(334,'183296',3,'2019-10-21 00:00:00',1),
(335,'183297',3,'2019-10-21 00:00:00',1),
(336,'183298',3,'2019-10-21 00:00:00',1),
(337,'183299',3,'2019-10-21 00:00:00',1),
(338,'183300',3,'2019-10-21 00:00:00',1),
(339,'186920',3,'2019-10-29 00:00:00',1),
(340,'186921',3,'2019-10-29 00:00:00',1);
...
(1202,'3664068423',241,2030,'3870022260','2601741755',1),
(1203,'3664068771',240,2031,'3870022302','2601718021',1),
(1204,'3664068006',227,2032,'3870022134','2601736869',1),
(1205,'3664068596',242,2033,'3870022245','2601739700',1),
(1206,'3664068900',230,2034,'3870022297','2601736993',1),
(1207,'3664068337',243,2035,'3870022325','2601741565',1),
(1208,'3664068994',232,2036,'3870022429','2601743822',1),
(1209,'3664068425',232,2037,'3870022305','2601742590',1),
(1210,'3664068210',233,2038,'3870022231','2601739452',1),
(1211,'3664068775',241,2039,'3870022405','2601747110',1),
(1212,'3664069115',227,2040,'3870022497','2601748908',1),
(1213,'3664069110',240,2041,'3870022480','2601747829',1),
(1214,'3664068769',228,2042,'3870022427','2601747585',1),
(1215,'3664069314',243,2043,'3870022707','2601747812',1),
(1216,'3664069315',227,2044,'3870022543','2601750777',1),
(1217,'3664069119',241,2045,'3870022494','2601748904',1),
(1218,'3664068099',240,2046,'3870022207','2601739250',1),
(1219,'3664069322',230,2047,'3870022519','2601744698',1),
(1220,'3664065350',230,2048,'3870021412','2601683063',1),
(1221,'3664069316',244,2049,'3870022470','2601747570',1),
(1222,'3664069326',244,2049,' ','2601754388',1),
(1223,'3664069311',242,2050,'3870022518','2601741740',1),
(1224,'3664068770',243,2051,'3870022422','2601746840',1);
...
(3072,1202,17,29180,0.07),
(3073,1203,17,59421.22,0.07),
(3074,1204,17,25871.24,0.07),
(3075,1205,17,62138.31,0.07),
(3076,1206,18,14180.7,0.09),
(3077,1207,17,96847.32,0.07),
(3078,1208,18,14784,0.09),
(3079,1209,18,15629.6,0.09),
(3080,1210,18,33330,0.09),
(3081,1211,17,29180,0.07),
(3082,1212,17,8313.58,0.07),
(3083,1213,17,29261.95,0.07),
(3084,1214,17,29180,0.07),
(3085,1215,17,100925.14,0.07),
(3086,1216,17,10909.52,0.07),
(3087,1217,17,14123.12,0.07),
(3088,1218,17,59769.89,0.07),
(3089,1219,18,15652.71,0.09),
(3090,1220,18,32078.28,0.09),
(3091,1221,17,9330.75,0.07),
(3092,1222,17,67.86,0.07),
(3093,1223,17,67751.79,0.07),
(3094,1224,17,69052.2,0.07);
...
(2,'Mohamed','UMHC@unilever.com','1234',4,0),
(4,'Hassan','UMF@unilever.com','12345',6,0),
(6,'Amr','MMT@unilever.com','123456',3,0),
(11,'Saber','UMPC@unilever.com','1234567',1,0);
...
DROP TABLE IF EXISTS `repobankreceipt`;
DROP VIEW IF EXISTS `repobankreceipt`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `repobankreceipt` AS select `bankreceipt`.`num` AS `BankREceipt`,`alldetailed`.`company` AS `company`,`alldetailed`.`export` AS `exportCertificate`,`alldetailed`.`Invoice` AS `invoice`,sum(`alldetailed`.`usdVal`) AS `USD` from ((`alldetailed` join `bankreceiptdata` on((`bankreceiptdata`.`exportCertificate` = `alldetailed`.`id`))) join `bankreceipt` on((`bankreceipt`.`id` = `bankreceiptdata`.`bankReceipt`))) group by `bankreceipt`.`num`,`alldetailed`.`export`,`alldetailed`.`Invoice`;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `repoerror` AS select `notsubmitted`.`export` AS `exportCertificate`,`notsubmitted`.`company` AS `company`,`notsubmitted`.`dat` AS `dat`,`notsubmitted`.`Invoice` AS `Invoice`,`notsubmitted`.`PORT` AS `PORT`,`notsubmitted`.`shippingCompany` AS `shippingCompany`,sum(`notsubmitted`.`usdVal`) AS `Export (USD)`,sum(`notsubmitted`.`PTR`) AS `PTR`,if(`notsubmitted`.`Cnolon`,if((`notsubmitted`.`nolonSupport` > 0),`notsubmitted`.`nolonSupport`,'False'),`notsubmitted`.`nolonSupport`) AS `Nolon Support`,if(`notsubmitted`.`Cmanifest`,if(`notsubmitted`.`manifesto`,`notsubmitted`.`manifestoSupport`,'FALSE'),0) AS `Manifesto Support`,`notsubmitted`.`bankreciete` AS `bankreciete`,if((`notsubmitted`.`boles` = 1),'True','False') AS `Boles`,`notsubmitted`.`notes` AS `notes` from `notsubmitted` group by `notsubmitted`.`export` order by `notsubmitted`.`export`;

DROP TABLE IF EXISTS `reposubmission`;
DROP VIEW IF EXISTS `reposubmission`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `reposubmission` AS select `submissiondata`.`submitDate` AS `submitDate`,`submissiondata`.`export` AS `export`,`submissiondata`.`expDate` AS `dat`,sum(`submissiondata`.`PTR`) AS `PTR`,sum(`submissiondata`.`manifestoSupport`) AS `manifestoSupport`,sum(`submissiondata`.`nolonSupport`) AS `nolonSupport`,`submissiondata`.`committee` AS `committee`,`submissiondata`.`company` AS `company` from `submissiondata` group by date_format(`submissiondata`.`submitDate`,'%M %Y'),date_format(`submissiondata`.`expDate`,'%M %Y'),`submissiondata`.`committee` order by `submissiondata`.`expDate`;

DROP TABLE IF EXISTS `reposubmissiondetails`;
DROP VIEW IF EXISTS `reposubmissiondetails`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `reposubmissiondetails` AS select `submissiondata`.`fileNo` AS `fileNo`,`submissiondata`.`submitDate` AS `submitDate`,`submissiondata`.`export` AS `export`,`submissiondata`.`expDate` AS `dat`,`submissiondata`.`country` AS `country`,`submissiondata`.`committee` AS `committee`,`submissiondata`.`usd` AS `exportusd`,`submissiondata`.`PTR` AS `PTR`,`submissiondata`.`nolonSupport` AS `nolonSupport`,`submissiondata`.`manifestoSupport` AS `manifestoSupport`,`submissiondata`.`company` AS `company` from `submissiondata` group by date_format(`submissiondata`.`submitDate`,'%M %Y'),date_format(`submissiondata`.`expDate`,'%M %Y'),`submissiondata`.`committee`,`submissiondata`.`export` order by `submissiondata`.`expDate`;

DROP TABLE IF EXISTS `repounderpreparinghardwork`;
DROP VIEW IF EXISTS `repounderpreparinghardwork`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `repounderpreparinghardwork` AS select `alldetailed`.`export` AS `export`,`alldetailed`.`PTR` AS `PTR`,`alldetailed`.`nolonSupport` AS `nolonSupport`,`alldetailed`.`manifestoSupport` AS `ManifestoSupport`,((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`) AS `total`,if((`alldetailed`.`manualWork` = 1),'True','False') AS `manualWork`,`alldetailed`.`company` AS `company` from `alldetailed` where (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) union select 'Total' AS `Total`,sum(`alldetailed`.`PTR`) AS `sum(PTR)`,sum(`alldetailed`.`nolonSupport`) AS `Sum(nolonSupport)`,sum(`alldetailed`.`manifestoSupport`) AS `sum(ManifestoSupport)`,sum(((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`)) AS `sum(PTR+nolonSupport+ManifestoSupport)`,' ' AS `Name_exp_13`,`alldetailed`.`company` AS `company` from `alldetailed` where (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) group by `alldetailed`.`company`;

DROP TABLE IF EXISTS `repounderpreparingwithmanualwork`;
DROP VIEW IF EXISTS `repounderpreparingwithmanualwork`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `repounderpreparingwithmanualwork` AS select `alldetailed`.`export` AS `export`,`alldetailed`.`PTR` AS `PTR`,`alldetailed`.`nolonSupport` AS `nolonSupport`,`alldetailed`.`manifestoSupport` AS `ManifestoSupport`,((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`) AS `total`,`alldetailed`.`manualWork` AS `manualWork`,`alldetailed`.`company` AS `company` from `alldetailed` where ((`alldetailed`.`boles` = 1) and (`alldetailed`.`manualWork` = 1) and (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) and `alldetailed`.`id` in (select `bankreceiptdata`.`exportCertificate` from `bankreceiptdata`)) union select 'Total' AS `Total`,sum(`alldetailed`.`PTR`) AS `sum(PTR)`,sum(`alldetailed`.`nolonSupport`) AS `Sum(nolonSupport)`,sum(`alldetailed`.`manifestoSupport`) AS `sum(ManifestoSupport)`,sum(((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`)) AS `sum(PTR+nolonSupport+ManifestoSupport)`,' ' AS `Name_exp_13`,`alldetailed`.`company` AS `company` from `alldetailed` where ((`alldetailed`.`boles` = 1) and (`alldetailed`.`manualWork` = 1) and (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) and `alldetailed`.`id` in (select `bankreceiptdata`.`exportCertificate` from `bankreceiptdata`)) group by `alldetailed`.`company`;

DROP TABLE IF EXISTS `repounderpreparingwithoutmanualwork`;
DROP VIEW IF EXISTS `repounderpreparingwithoutmanualwork`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `repounderpreparingwithoutmanualwork` AS select `alldetailed`.`export` AS `export`,`alldetailed`.`PTR` AS `PTR`,`alldetailed`.`nolonSupport` AS `nolonSupport`,`alldetailed`.`manifestoSupport` AS `ManifestoSupport`,((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`) AS `total`,`alldetailed`.`manualWork` AS `manualWork`,`alldetailed`.`company` AS `company` from `alldetailed` where ((`alldetailed`.`boles` = 1) and (`alldetailed`.`manualWork` = 0) and (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) and `alldetailed`.`id` in (select `bankreceiptdata`.`exportCertificate` from `bankreceiptdata`)) union select 'Total' AS `Total`,sum(`alldetailed`.`PTR`) AS `sum(PTR)`,sum(`alldetailed`.`nolonSupport`) AS `Sum(nolonSupport)`,sum(`alldetailed`.`manifestoSupport`) AS `sum(ManifestoSupport)`,sum(((`alldetailed`.`PTR` + `alldetailed`.`nolonSupport`) + `alldetailed`.`manifestoSupport`)) AS `sum(PTR+nolonSupport+ManifestoSupport)`,' ' AS `Name_exp_13`,`alldetailed`.`company` AS `company` from `alldetailed` where ((`alldetailed`.`boles` = 1) and (`alldetailed`.`manualWork` = 0) and (not(`alldetailed`.`id` in (select `filenodata`.`exportCertificate` from `filenodata`))) and `alldetailed`.`id` in (select `bankreceiptdata`.`exportCertificate` from `bankreceiptdata`)) group by `alldetailed`.`company`;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `submissiondata` AS select `fileno`.`num` AS `fileNo`,`fileno`.`dat` AS `submitDate`,`alldetailed`.`dat` AS `expDate`,`alldetailed`.`export` AS `export`,sum(`alldetailed`.`PTR`) AS `PTR`,sum(`alldetailed`.`usdVal`) AS `usd`,`alldetailed`.`country` AS `country`,`alldetailed`.`nolonSupport` AS `nolonSupport`,`alldetailed`.`manifestoSupport` AS `manifestoSupport`,`alldetailed`.`committee` AS `committee`,`alldetailed`.`company` AS `company` from ((`alldetailed` join `filenodata` on((`filenodata`.`exportCertificate` = `alldetailed`.`id`))) join `fileno` on((`fileno`.`id` = `filenodata`.`fileNo`))) group by `alldetailed`.`id`,`alldetailed`.`company`,`alldetailed`.`committee`;
...
-- Dump completed on 2020-01-13 11:20:45
-- Total time: 0:0:0:0:726 (d:h:m:s:ms)
